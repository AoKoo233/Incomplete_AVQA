...
def imagebind_huge(pretrained=False):
    ...
    if pretrained:
        ...
        if not os.path.exists("/public/home/cit_qilangye/project/CVPR/checkpoints/imagebind_huge.pth"):
            print(
        ...
        model.load_state_dict(torch.load("/public/home/cit_qilangye/project/CVPR/checkpoints/imagebind_huge.pth", weights_only=True))
